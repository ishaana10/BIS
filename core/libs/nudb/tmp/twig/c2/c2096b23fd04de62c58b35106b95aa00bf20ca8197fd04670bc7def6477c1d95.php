...
class __TwigTemplate_80bfc0cd984c02902b40215f9d9bb269aaebe2fd8f699330960ea0cd5511e02e extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Ignore");
            ...
            foreach ($context['_seq'] as $context["field_name"] => $context["field_type"]) {
                // line 170
                echo "                                    ";
                if ((((0 !== twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 170), "FULLTEXT")) || preg_match("/(char|text)/i",                 // line 171
...
";
    ...
    {
        return new Source("", "table/index_form.twig", "/home/ictfjcom/public_html/BIS_DEV/core/libs/nudb/templates/table/index_form.twig");
    }
}
